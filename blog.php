            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> How to earn money online at home.</div>
                        <div class="most_fh5co_treding_font_123"> <script>document.write(new Date().getFullYear());</script></div>
                    </div>
                </div>
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                    ...
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Block bindings in javascript.</div>
                        <div class="most_fh5co_treding_font_123"> <script>document.write(new Date().getFullYear());</script></div>
                    </div>
                </div>
               <!-- <div class="row pb-3">
