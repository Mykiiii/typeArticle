    ...
    <div class="container">
        <div class="row">
            <div class="col-12 fh5co_mediya_center"><a href="#" class="color_fff fh5co_mediya_setting"><i
                    class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;<script>document.write(new Date().getFullYear());</script></a>
                <div class="d-inline-block fh5co_trading_posotion_relative"><a href="#" class="treding_btn">Trending</a>
                    <div class="fh5co_treding_position_absolute"></div>
                </div>
                <a href="#" class="color_fff fh5co_mediya_setting">Follow us on instagram to get latest updates.</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                <div class="text-center d-inline-block">
                    <a class="fh5co_display_table"><div class="fh5co_verticle_middle">Type</div></a>
                </div>
                <div class="text-center d-inline-block">
              ...
              <div class="text-center d-inline-block">
                    <a  target="_blank" class="fh5co_display_table"><div class="fh5co_verticle_middle"><i class="fa fa-facebook"></i></div></a>
                </div>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
							...
							<a class="dropdown-item" href="#">Song lyrics</a>
                        </div>
                    </li>
                   <!-- <li class="nav-item dropdown">
...
<div id="fh5co-title-box" style="background-image: url(images/camila-cordeiro-114636.jpg); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
    ...
    <div class="page-title">
        ...
        <h2>Block Bindings in Javascript.</h2>
    </div>
</div>
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <p>
                   Traditionally, the way variable declarations work has been one tricky part of programming in JavaScript. In most C-based languages, variables (more formally known as bindings, as a name is bound to a value inside a scope) are created at the spot where the declaration occurs. 
                </p>
                <p>
				...
				<p>
				1) var Declarations and Hoisting: <br><br>
Variable declarations using var are treated as if they’re at the top of the function (or in the global scope, if declared outside of a function) regardless of where the actual declaration occurs; this is called hoisting. 
               <br><br>  2) Block-Level Declarations:<br><br>
Block-level declarations declare bindings that are inaccessible outside a given block scope. Block scopes, also called lexical scopes, are created in the following places: 
                ...
                <ul>
                    ...
                    <li>Inside a block (indicated by the { and } characters) </li>
                    
                </ul>
				
                
				<p>
				Block scoping is how many C-based languages work, and the introduction of block-level declarations in ECMAScript 6 is intended to provide that same flexibility (and uniformity) to JavaScript.<br><br>

<br>
3) Global Block Bindings:<br><br>
...
<br><br>4) Emerging Best Practices for Block Bindings: <br><br>
    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-3">
                ...
                <div class="footer_sub_about pb-3"> TypeArticle will give you the exact information on the topic, after reading this you'll not need any other blog to read.
                </div>
           ...
           <!-- <div class="col-12 col-md-3 col-lg-2">
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <div class="footer_makes_sub_font"> <script>document.write(new Date().getFullYear());</script></div>
                <a href="#" class="footer_post pb-4"> How to earn money online.</a>
                <div class="footer_makes_sub_font"> <script>document.write(new Date().getFullYear());</script></div>
                <a href="#" class="footer_post pb-4"> Block bindings in javascript </a>
...
<div class="container-fluid fh5co_footer_right_reserved">
    <div class="container">
        <div class="row  ">
            <div class="col-12 col-md-6 py-4 Reserved"> © Copyright <script>document.write(new Date().getFullYear());</script>, All rights reserved by TypeArticle. </div>
