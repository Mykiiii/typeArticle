            ...
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        <span class="c_g d-block">Text Us</span>
                        <span class="d-block c_g fh5co_contact_us_no_text">+91 6295803610</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="col-md-4 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        ...
                        <span class="d-block c_g fh5co_contact_us_no_text">mohitmv.com</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form" action="contact.php" method="post" >
                    <div class="col-12 py-3">
                        <input type="text" name="user" class="form-control fh5co_contact_text_box" placeholder="Enter Your Name" />
                    </div>
                    ...
                    <div class="col-12 py-3 text-center"><input type="submit" name="send" class="btn contact_btn"> </div>
                </form>
            </div>
    ...
    <div class="container animate-box">
        <div class="row">
           ...
           <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <a href="earn.html" class="footer_post pb-4"> How to earn money online.</a>
                <div class="footer_makes_sub_font"><script>document.write(new Date().getFullYear());</script></div>
                <a href="block.html" class="footer_post pb-4"> Block binding in javascript </a>
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a  class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
